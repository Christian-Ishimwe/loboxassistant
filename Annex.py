...
class SettingWindow:
    ...
    def settingWindow(self,root):
        ...
        self.volume=ttk.Label(self.setting,text="Lobox's Volume: ",borderwidth=0,font=('"Times New Roman"')).place(x=3,y=17)
...
class Weather:
    def show(self,scrollable_text):
        SR=SpeakRecog(scrollable_text)
        base_url = f"""http://api.openweathermap.org/data/2.5/weather?q=Kigali,IN&units=metric&appid=ea45752424c9cad83b4f5c836ced6b1a"""
